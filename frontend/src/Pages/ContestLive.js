...
const ContestLive = () => {
  ...
  useEffect(()=>{
    ...
    async function fetchData(){
      try {
        const response= await axios.get(`https://codebyte-if2s.onrender.com/api/contest/details/${id}`, { withCredentials: true });
  ...
  useEffect(()=>{
    ...
    async function fetchData(){
      try {
        if(contestData){
          const responseCreator= await axios.get(`https://codebyte-if2s.onrender.com/api/user/getDetails/${contestData.creator}`, { withCredentials: true });
          const responseParticipant= await axios.get(`https://codebyte-if2s.onrender.com/api/contest/sortedParticipants/${id}`)
  ...
  useEffect(()=>{
    if(f){
      axios.get(`https://codebyte-if2s.onrender.com/api/contest/details/${id}`, { withCredentials: true })
  ...
  const handlePenalty= async(submissions)=>{
    ...
    let solved= []
    try {
      const res= await axios.get(`https://codebyte-if2s.onrender.com/api/contest/details/${id}`, { withCredentials: true })
  ...
  const handleSubmission= async()=>{
    try {
      ...
      await axios.put(`https://codebyte-if2s.onrender.com/api/contest/attempt/${id}`, 
